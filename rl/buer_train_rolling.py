...
def get_buer_rolling_cfgs():
    ...
    reward_cfg = {
        ...
        # All reward scales should be positive numbers
        "reward_scales": {
            "forward_velocity_tracking": 3.0,
            "rolling_velocity": 7.0,
            "reverse_rolling": 7.0,
            "consistent_rolling_direction": 5.0,
